...
void aFunction(SampleListener listener,Leap::Controller controller,LeapGui lg,QLabel *imglbl,QLabel *chrlbl){
...
int main(int argc, char * argv[]){
    ...
    extern void aFunction(SampleListener arg1, Leap::Controller arg2, LeapGui arg3,QLabel arg4,QLabel arg5);
    ...
    QFuture<void> future = QtConcurrent::run(aFunction, listener, controller, lg,imglbl,chrlbl);
